...
<acme:list>
	...
	<acme:list-column code="lecturer.course.list.label.abstractText" path="abstractText" width="20%"/>
	<acme:list-column code="lecturer.course.list.label.courseType" path="courseType" width="20%"/>
